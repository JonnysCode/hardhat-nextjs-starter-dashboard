    ...
    <>
      <div>
                        ...
                        <a
                          ...
                          className={classNames(
                            item.current
                              ...
                              : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 hover:text-gray-900 dark:hover:bg-gray-700 dark:hover:text-white',
        ...
        <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
          ...
          <div className="flex flex-col flex-grow border-r border-gray-200  bg-white overflow-y-auto dark:bg-gray-800 dark:border-gray-900">
        ...
        <div className="md:pl-64 flex flex-col flex-1">
          <div className="sticky top-2 z-10 mx-2 flex-shrink-0 flex h-16 bg-white dark:bg-blue-900">

            <SidebarMenu setSidebarOpen={setSidebarOpen(true)}/>
